    ...
    while True:
        ...
        if choice.upper() == "EXIT":
            ...
            if int(inv_monster_data[monster_upgrade_index]["level"]) < 5:
                ...
                if user_money >= cost:
                    while True:
                        textbox(f"currently you have {user_money} owca coin. its going to cost you {cost} owca coins, are you sure you want to upgrade this monster?")
                        confirm = input("➤ ")
                        if confirm.upper() == "Y":
            ...
            else: textbox("it seems that your monster is at its maximum level")
        else:
