...
███████████████▒░░░░░░░░▒▓▒▒▒█▒░░▒░░██████████████       
          """)
    textbox("welcome to Makise's Grand Laboratory, may i help you by any chance?")
    while True:
        textbox("i can make your monster to be stronger than ever! choose the one you'd like to upgrade")
        ...
        if choice.upper() == "EXIT":
            ...
            monster_upgrade_index = index(inv_monster_data,
                                          current_user_monsters[int(choice) - 1]["current_monster_id"], "monster_id")
            if int(inv_monster_data[monster_upgrade_index]["level"]) < 5:
                ...
                if user_money >= cost:
                    while True:
                        textbox(
                            f"currently you have {user_money} owca coin. its going to cost you {cost} owca coins, are you sure you want to upgrade this monster?")
                        confirm = input("➤ ")
                        if confirm.upper() == "Y":
                    ...
                    textbox("um sorry we don't serve poor people here. come again when you have da bag.")
            else:
